...
The [premium version](https://rckflr.com/products/open-pricing/ "Upgrade to Product Open Pricing for WooCommerce Pro") will allow setting open pricing on multiple (i.e. unlimited number) products without restrictions.

= More =
* We are open to your suggestions and feedback.
* Visit the [Open Pricing plugin page](https://rckflr.com/products/open-pricing/).
...
## Privacy Policy
Open Pricing uses [Appsero](https://appsero.com) SDK to collect some telemetry data upon user's confirmation. This helps us to troubleshoot problems faster & make product improvements.
