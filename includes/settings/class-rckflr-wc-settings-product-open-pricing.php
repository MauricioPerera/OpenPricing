...
class Alg_WC_Settings_Product_Open_Pricing extends WC_Settings_Page {
	...
	function __construct() {
		...
		$this->label = __( 'Product Open Pricing', 'open-pricing' );
		parent::__construct();
	...
	function get_settings() {
		...
		return array_merge( apply_filters( 'woocommerce_get_settings_' . $this->id . '_' . $current_section, array() ), array(
			array(
				'title'     => __( 'Reset Settings', 'open-pricing' ),
				'type'      => 'title',
				'id'        => $this->id . '_' . $current_section . '_reset_options',
			),
			array(
				'title'     => __( 'Reset section settings', 'open-pricing' ),
				'desc'      => '<strong>' . __( 'Reset', 'open-pricing' ) . '</strong>',
	...
	function admin_notice_settings_reset() {
		echo '<div class="notice notice-warning is-dismissible"><p><strong>' .
			__( 'Your settings have been reset.', 'open-pricing' ) . '</strong></p></div>';
	}
